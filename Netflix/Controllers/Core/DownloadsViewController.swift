...
class DownloadsViewController: UIViewController {
    ...
    private func fetchLocalStorageForDownload() {
        DataPersistenceManager.shared.fetchingTitlesFromDatabase(completion: { [weak self] result in
            switch result {
        ...
        APICaller.shared.getMovie(with: titleName, completion: { [weak self] result in
            ...
            case .success(let videoElement):
                DispatchQueue.main.async {
                    ...
                    vc.configureTitlePreview(with: TitlePreviewViewModel(title: titleName, youtubeView: videoElement, titleOverview: title.overview ?? ""))
